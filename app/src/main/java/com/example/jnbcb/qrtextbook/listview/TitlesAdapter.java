...
import com.example.jnbcb.qrtextbook.TitlesActivity;
...
public class TitlesAdapter extends ArrayAdapter<Textbook> {
    private Context context;

    public TitlesAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<Textbook> articles) {
                ...
                Thread thread = new Thread() {
                    public void run() {
                        ...
                        ((Activity) context).runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                               // ((TitlesActivity) context).dataChanged();
